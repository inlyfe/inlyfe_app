...
from accounts.models import User, Vendor, Reception, Office
...
class ReceptionSignupSerializer(serializers.ModelSerializer):
...
class OfficeSignupSerializer(serializers.ModelSerializer):
    password2 = serializers.CharField(style={"input_type": 'password2'}, write_only=True)
    class Meta:
        model = User
        fields = ['username', 'email', 'password', 'password2']
