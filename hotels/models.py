...
def room_images_upload_path(instance, file_name):
    return f"{instance.room_slug}/Hotel/Room/room_cover/{file_name}"


def room_display_images_upload_path(instance, file_name):
    return f"{instance.room.room_slug}/Hotel/Room/Display/room_display/{file_name}"
...
class Room(models.Model):
    ...
    cover_image = models.ImageField(upload_to=room_images_upload_path, null=True)
...
class RoomDisplayImages(models.Model):
    room = models.ForeignKey(Room, on_delete=models.CASCADE)
    display_images = models.ImageField(upload_to=room_display_images_upload_path, null=True)
